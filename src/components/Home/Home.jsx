...
export default function Home() {
    ...
    // 🔴 Tips Array
    const tips = [
        "Have iron-rich foods like red meat, fish, poultry, beans, spinach or raisins.",
        ...
        "Avoid heavy exercise after donating blood.",
        "Blood donation can save up to 3 lives.",
        "You can donate blood every 3 months safely.",
        "Rest for at least 10 minutes after donating blood."
    ];
    ...
    return (
        <div className="mx-auto w-full max-w-7xl">
            ...
            <marquee behavior="scroll" direction="left" scrollamount="6" className="text-xl font-semibold text-red-700"> 
                ❤️ “Your Blood Can Give Someone Another Chance at Life.” 
            </marquee>
            ...
            <div className='border-t'>
                <div className="flex flex-col sm:flex-row items-center justify-center text-center sm:text-left gap-3 px-4 mt-6">
                    ...
                    <motion.p
                        ...
                        className="text-gray-700 text-base sm:text-lg max-w-3xl sm:max-w-none leading-relaxed"
                    >
                        <b className="text-red-700">Tip:</b> {tips[currentTip]}
                    </motion.p>
